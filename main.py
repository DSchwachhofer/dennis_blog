...
def home():
    ...
    return render_template("index.html", page="home", title=title, subtitle=subtitle, image_url=url_for('static', filename='images/banner-home.jpg'), posts=all_posts)
...
def create_new_post():
    ...
    return render_template("new-post.html", title="Inspirtion", subtitle="is the art of finding magic in the ordenary" , image_url=url_for('static', filename='images/banner-new-post.jpg'), form=form)
...
def show_post(post_id):
    ...
    return render_template("post.html", title=post.title, subtitle=post.subtitle, image_url=image_url, post=post)
